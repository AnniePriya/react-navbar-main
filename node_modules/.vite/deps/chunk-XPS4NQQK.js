...
function createContainer(options = {}) {
  ...
  const Container2 = React15.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React16.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React16.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React16.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React16.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React17.Children.toArray(children2).filter(Boolean);
...
true ? ButtonBase.propTypes = {
   ...
   * @default 'a'
   */
  LinkComponent: import_prop_types18.default.elementType,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onContextMenu: import_prop_types18.default.func,
  /**
   * @ignore
   */
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XPS4NQQK.js.map
